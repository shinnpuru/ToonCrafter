...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77,
        ...
        import os
        if os.path.exists('checkpoints\clip-vit-large-patch14'):
            self.tokenizer = CLIPTokenizer.from_pretrained('checkpoints\clip-vit-large-patch14')
            self.transformer = CLIPTextModel.from_pretrained('checkpoints\clip-vit-large-patch14')
        else:
